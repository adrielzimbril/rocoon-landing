...
- Before metadata, README, SEO, landing-page structure, or challenge copy work, inspect `https://github.com/adrielzimbril/oleap-landing` and follow its structure as the reference.
...
- Keep the established challenge README structure from `oleap-landing`.
...
- Open the folder `oleap-landing` and inspect its metadata implementation to understand the metadata structure I want
- Always include SEO metadata in `src/app/layout.tsx`.
- Follow the exact `oleap-landing` metadata structure:
  - `metadataBase`
  - `title`
  - `description`
  - `keywords`
...
- Before setting GitHub repository metadata, inspect `https://github.com/adrielzimbril/oleap-landing` and mirror its structure.
...
- Add GitHub topics following the leap pattern, adapted to the project:
  - `ai-challenge`
  - `ai-landing-page`
...
- Follow the current Oleap Landing design language: modern, minimal, high-end, image-led, and product-focused.
